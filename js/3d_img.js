...
window.addEventListener('deviceorientation', (e) => {
  const { beta, gamma } = e;
  const tiltY = beta * 2; // Amplify the tilt effect by multiplying with a scaling factor
  const tiltX = gamma * 2; // Amplify the tilt effect by multiplying with a scaling factor
